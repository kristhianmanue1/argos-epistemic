...
Tests en verde: **62**. Objetivo `G=refactorizacion`, aspectos `['algorithm', 'config', 'test', 'doc']`, NF `['sec']`, θ=0.8, ρ=0.25.
...
- Grafo de llamadas L3 (Python AST, subgrafo de producción): 232 nodos / 343 aristas (165 producción). Top impacto: main (0.64), _argos_md (0.628), analyze_path (0.622), _third_party_md (0.622).
- Comportamiento L4 (AST best-effort, Σ_4): 1 fn levantan, 62 con asserts, 9 mutan self, 0 validan (175/244 producción).
