...
Tests en verde: **59**. Objetivo `G=refactorizacion`, aspectos `['algorithm', 'config', 'test', 'doc']`, NF `['sec']`, θ=0.8, ρ=0.25.

## Extracción (discovery barato + índice L3)

- Artefactos descubiertos: **32** (por nivel `{0: 3, 1: 1, 2: 4, 3: 1, 4: 22, 5: 1}`, por tipo `{'topology': 1, 'callgraph': 1, 'behavior': 1, 'config': 4, 'doc': 6, 'code': 18, 'test': 1}`).
- Grafo de llamadas L3 (Python AST, subgrafo de producción): 221 nodos / 330 aristas (159 producción). Top impacto: main (0.665), _argos_md (0.652), _third_party_md (0.646), _test_count (0.627).
- Comportamiento L4 (AST best-effort, Σ_4): 1 fn levantan, 59 con asserts, 9 mutan self, 0 validan (169/233 producción).
...
cost            : estimated=35124 observed=35124
```
...
_Generado desde HEAD del pipeline. raw report: `{"evidence_count": 32, "proposition_count": 15, "coverage": 0.4167, "residual_risk": 0.35, "complete": false}`_
