...
Tests en verde: **943**. Objetivo `G=refactorizacion`, aspectos `['algorithm', 'config', 'test', 'doc']`, NF `['sec']`, θ=0.8, ρ=0.25. Perfil semántico explícito: `char-ngram-v1`.
...
- Grafo de llamadas L3 (Python AST, subgrafo de producción): 762 nodos / 1275 aristas (309 producción). Top impacto: analyze_path (0.594), main (0.545), _check_one (0.542), check_case (0.539).
- Comportamiento L4 (AST best-effort, Σ_4): 40 fn levantan, 380 con asserts, 10 mutan self, 2 validan (323/790 producción).
