...
Tests en verde: **61**. Objetivo `G=refactorizacion`, aspectos `['algorithm', 'config', 'test', 'doc']`, NF `['sec']`, θ=0.8, ρ=0.25.
...
- Grafo de llamadas L3 (Python AST, subgrafo de producción): 230 nodos / 342 aristas (165 producción). Top impacto: main (0.64), _argos_md (0.628), analyze_path (0.622), _third_party_md (0.622).
- Comportamiento L4 (AST best-effort, Σ_4): 1 fn levantan, 61 con asserts, 9 mutan self, 0 validan (175/242 producción).
...
cost            : estimated=36631 observed=36631
```
...
_Generado desde HEAD del pipeline. raw report: `{"evidence_count": 34, "proposition_count": 18, "coverage": 0.5, "residual_risk": 0.175, "complete": false}`_
