...
Tests en verde: **910**. Objetivo `G=refactorizacion`, aspectos `['algorithm', 'config', 'test', 'doc']`, NF `['sec']`, θ=0.8, ρ=0.25. Perfil semántico explícito: `char-ngram-v1`.
...
- Grafo de llamadas L3 (Python AST, subgrafo de producción): 729 nodos / 1212 aristas (301 producción). Top impacto: analyze_path (0.587), main (0.547), _check_one (0.543), check_case (0.54).
- Comportamiento L4 (AST best-effort, Σ_4): 36 fn levantan, 359 con asserts, 10 mutan self, 2 validan (315/756 producción).

## Reporte

```text
evidence_count  : 62
proposition_count: 24
relations        : {'mentions': 24}
conflict_count  : 0
coverage        : 0.0
residual_risk   : 1.0
complete        : False
...
_Generado desde HEAD del pipeline. Manifest de entradas fijadas: `sha256:3f654555197b56f9b403b448b1bade788bd685082e90b34f1b3f6cd41d5472ab` (perfil semántico, revisión del target, evaluador, frescura y presupuesto). raw report: `{"evidence_count": 62, "proposition_count": 24, "coverage": 0.0, "residual_risk": 1.0, "complete": false}`_
