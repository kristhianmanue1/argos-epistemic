...
- Artefactos descubiertos: **41** (por nivel `{0: 3, 1: 1, 2: 4, 3: 1, 4: 28, 5: 4}`, por tipo `{'topology': 1, 'callgraph': 1, 'behavior': 1, 'config': 4, 'doc': 6, 'code': 24, 'test': 4}`).
...
cost            : estimated=45501 observed=45501
inventory       : {'profile': 'legacy-first-400-v1', 'files_discovered': 48, 'files_eligible': 38, 'files_selected': 38, 'files_omitted_by_cap': 0, 'read_truncations': 9, 'bytes_discovered': 354825, 'bytes_read': 175186, 'degradations': ['content_truncated'], 'fingerprint': 'sha256:a0a96a26cc284ced6c4e421abfc5d53d16e3f40b646778a57ac44be86f133b50'}
...
_Generado desde HEAD del pipeline. raw report: `{"evidence_count": 41, "proposition_count": 18, "coverage": 0.0, "residual_risk": 0.7, "complete": false}`_
