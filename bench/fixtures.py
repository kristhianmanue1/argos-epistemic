...
AUTH = {
    ...
    "goal": {"name": "audit_auth", "aspects": ["auth", "login", "token"], "theta_coverage": 0.9, "rho_risk": 0.1, "link_threshold": 0.20},
...
MATH = {
    ...
    "goal": {"name": "audit_math", "aspects": ["vector", "matrix", "statistics"], "theta_coverage": 0.9, "rho_risk": 0.1, "link_threshold": 0.20},
